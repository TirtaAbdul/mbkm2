    ...
    <div class="row mx-8">
        <div class="col-12 col-xl-12">
            <div class="card card-body border-0 shadow mb-4">
                <div class="clearfix">
                    <a class="btn btn-danger btn-lg float-end" href="../reviewer/template.php?page=tolak" role="button">Keluar (X)</a>
                </div>
                                ...
                                <form action="" method="POST" accept-charset="utf-8">
                                    ...
                                    ?>
                                                ...
                                                <div class="modal-footer mt-3">
                                                    <a href="../reviewer/template.php?page=tolak"><input type="button" value="KEMBALI" class="btn btn-danger btn-lg"></input></a>
                                                    <!-- Button Modal ADD DOSPEM dan SETUJUI AJUAN -->
                                                    <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#exampleModal">UBAH KE SETUJUI</button>
