    ...
    <div class="row mx-2">
        <div class="col-12 col-xl-12">
            <div class="card card-body border-0 shadow mb-4">
                <div class="clearfix">
                    <a class="btn btn-danger btn-sm" href="../mahasiswa/template.php?page=pengajuan" role="button">Keluar (X)</a>
                </div>
                <h2 class="h10 mt-3 mb-5 text-center"><b>Pra-Syarat Ajuan yang Wajib Dilengkapi</b></h2>
                <div id="table-employee" class="mt-5 mx-5">
                    <table id="example" class="table table-striped" >
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"> <a href="../mahasiswa/template.php?page=form_pendaftaran&&id_formulir=<?= $id_formulir ?>"><button class="btn btn-secondary btn-lg">
                                        <h5>Lengkapi Data</h5>
                                    </button></a></td>
                        </tr>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="modal-footer mt-3" style="float:right">
                                    <input type="submit" value="AJUKAN SEKARANG!" name="ajukansekarang" class="btn btn-info btn-m" onclick="return confirm('Yakin ingin mengajukan sekarang juga? PASTIKAN ANDA TELAH MENGISI SELURUH SYARAT DI ATAS! Setelah diajukan, Anda tidak dapat mengubahnya kembali!')"></input>
                                </div>
                            </div>
                        </div>
                    </form>
