    ...
    <div class="row mx-8">
        <div class="col-12 col-xl-12">
            <div class="card card-body border-0 shadow mb-4">
                <div class="clearfix">
                    <a class="btn btn-danger btn-lg float-end" href="../sekjur/template.php?page=peserta_kegiatan" role="button">Keluar (X)</a>
                </div>
                        ...
                        <div id="employee_table" class="table-responsive">
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td> <a href="../sekjur/template.php?page=ajuan_view&&id_formulir=<?= $id_formulir ?>"><button class="btn btn-secondary btn-sm">Detail</button></a></td>
                                </tr>
                                <tr>
                                    <th>Hasil Asesmen Ajuan</th>
                                    <td> <a href="../sekjur/template.php?page=hasil_asesmen&&id_formulir=<?= $id_formulir ?>"><button class="btn btn-secondary btn-sm">Detail</button></a></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td> <a href="../sekjur/template.php?page=logbook&&id_formulir=<?= $id_formulir ?>"><button class="btn btn-secondary btn-sm">Detail</button></a></td>
                                </tr>
                                <tr>
                                    <th>Laporan Akhir Kegiatan</th>
                                    <td><a href="../sekjur/template.php?page=laporan_akhir&&id_formulir=<?= $id_formulir ?>"><button class="btn btn-secondary btn-sm">Detail</button></a></td>
                                </tr>
                                <tr>
                                    <th>Umpan Balik Mahasiswa</th>
                                    <td>
                                        <a href="../sekjur/template.php?page=umpan_balik_view&&id_formulir=<?= $id_formulir ?>"><button class="btn btn-secondary btn-sm">Detail</button></a>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Instrumentasi Nilai Kegiatan</th>
                                    <td>
                                        <a href="../sekjur/template.php?page=nilai_view&&id_formulir=<?= $id_formulir ?>"><button class="btn btn-secondary btn-sm">Detail</button></a>
                                </tr>
                            </table>
                        </div>
                    </div>
